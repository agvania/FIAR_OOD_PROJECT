...
public class MyBoard extends ObservableBoard {
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#putDiscInColumn(int, gamecomponents.Disc)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#getTopIndex(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#getTop(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#extractTop(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#lowestAvailable(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#columnFull(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#columnNotFull(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#getDisc(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#getWidth()
	 */
	@Override
	public int getWidth() {
		return width;
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#getHeight()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#notifyObservers(int, int, gamecomponents.Disc)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see gamecomponents.Board#clone()
	 */
	@Override
	public Board clone() {
